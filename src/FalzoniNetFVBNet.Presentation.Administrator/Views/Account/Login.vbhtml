@ModelType FalzoniNetFVBNet.Presentation.Administrator.Models.Identity.LoginModel
...
<body class="hold-transition login-page">
    ...
    <div class="login-box">
        ...
        <div class="login-box-body">
            ...
            <h4 class="login-box-msg">@FalzoniNetFVBNet.Resources.My.Resources.Domain.AdministrationPanel</h4>

            @Using (Html.BeginForm("Login", "Account", FormMethod.Post, New With {.class = "form-signin"}))
                @Html.AntiForgeryToken()

                @<div class="form-group has-feedback">
                    @Html.TextBoxFor(Function(x) x.Login, New With {.id = "Email", .class = "form-control", .autofocus = "autofocus", .placeholder = FalzoniNetFVBNet.Resources.My.Resources.Login.Email})
                    <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
                </div>
                @<div class="form-group has-feedback">
                    @Html.TextBoxFor(Function(x) x.Password, New With {.type = "password", .id = "Senha", .class = "form-control", .placeholder = FalzoniNetFVBNet.Resources.My.Resources.Login.Password})
                    ...
                    <div class="col-xs-8">
                        <div class="checkbox icheck">
                            <label for="RememberMe">
                                @Html.CheckBoxFor(Function(x) x.RememberMe) @FalzoniNetFVBNet.Resources.My.Resources.Login.RememberMe
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <button type="submit" class="btn btn-success btn-block btn-flat">@FalzoniNetFVBNet.Resources.My.Resources.Actions.Enter</button>
                    </div>
                </div>
            End Using
            <br />
            @Html.ActionLink(FalzoniNetFVBNet.Resources.My.Resources.Login.ForgotMyPassword, "ForgotPassword", "Account")
        </div>
    </div>

    <div class="container container-footer">
        <footer>
            <p>&copy; @Date.Now.Year - Renato Falzoni - @FalzoniNetFVBNet.Resources.My.Resources.Login.Copyright</p>
        </footer>
    </div>
